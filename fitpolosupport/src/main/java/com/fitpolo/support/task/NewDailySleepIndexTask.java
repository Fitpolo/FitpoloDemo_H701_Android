 ...
 * @ClassPath com.fitpolo.support.task.NewDailySleepIndexTask
 */
public class NewDailySleepIndexTask extends OrderTask {
    public String lastSyncTime;// yyyy-MM-dd HH:mm

    public NewDailySleepIndexTask(OrderCallback callback, String lastSyncTime) {
        setOrder(OrderEnum.getNewDailySleepIndex);
    ...
    public byte[] assemble(Object... objects) {
        ...
        byteArray[6] = (byte) FitConstant.RESPONSE_HEADER_SLEEP_INDEX;
        return byteArray;
    }
}
