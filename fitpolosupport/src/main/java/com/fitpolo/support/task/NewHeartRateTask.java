 ...
 * @ClassPath com.fitpolo.support.task.NewHeartRateTask
 */
public class NewHeartRateTask extends OrderTask {
    private String lastSyncTime;// yyyy-MM-dd HH:mm

    public NewHeartRateTask(OrderCallback callback, String lastSyncTime) {
        setOrder(OrderEnum.getNewHeartRate);
    ...
    public byte[] assemble(Object... objects) {
        ...
        byteArray[6] = (byte) FitConstant.RESPONSE_HEADER_HEART_RATE;
        return byteArray;
    }
}
