 ...
 * @Author wenzheng.liu
 * @Description 设置来电震动
 * @ClassPath com.fitpolo.support.task.PhoneComingShakeTask
 */
public class PhoneComingShakeTask extends OrderTask {

    private String showText;
    private boolean isPhoneNumber;

    public PhoneComingShakeTask(OrderCallback callback, String showText, boolean isPhoneNumber) {
        setOrder(OrderEnum.setPhoneComingShake);
