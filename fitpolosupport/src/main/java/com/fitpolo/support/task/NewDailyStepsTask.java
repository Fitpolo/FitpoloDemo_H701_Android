 ...
 * @ClassPath com.fitpolo.support.task.NewDailyStepsTask
 */
public class NewDailyStepsTask extends OrderTask {
    private String lastSyncTime;// yyyy-MM-dd HH:mm

    public NewDailyStepsTask(OrderCallback callback, String lastSyncTime) {
        setOrder(OrderEnum.getNewDailySteps);
    ...
    public byte[] assemble(Object... objects) {
        ...
        byteArray[6] = (byte) FitConstant.RESPONSE_HEADER_STEP;
        return byteArray;
    }
}
